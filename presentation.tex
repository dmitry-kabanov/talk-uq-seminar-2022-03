...
where
% \[
% R_{\perp}\(\phi, \vec \psi) = < \Grad \phi \Curl \vec \psi >_{L^2(D)}
% \]
...
\begin{frame}
\frametitle{Visualization of multilayer perceptron $\R^4 \to \R$ with one hidden layer}
...
\section{Training process and algorithms}
